...
export default function PolicyPage() {
  return (
    <div className="p-8">
      <img src="playstore.png" alt="Readio" className="h-[100px] mb-3" />
      <h3>Privacy Policy</h3>
      <h4>Introduction</h4>
      <p>
        Our privacy policy will help you understand what information we collect
        at Readio, how Readio uses it, and what choices you have. Apptify built
        the Readio app as a free app. This SERVICE is provided by Readio at no
